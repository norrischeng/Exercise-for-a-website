...
<![endif]-->
								...
								<div class="my-account">
									<div class="dashboard">
										<div class="page-title">
											<h1><strong>账户信息</strong> / account information </h1>
										</div>
    ...
    <div class="item clearfix">
        ...
        <div class="item-right"><span class="info">727085496</span></div>
    </div>
    -->
												<div class="item clearfix">
													<span class="item-left">电子邮箱地址:</span>
													<div class="item-right"><span class="info">${sessionScope.userInfo.mailbox}</span></div>
												</div>
												<div class="item clearfix">
													<span class="item-left">账户密码:</span>
													<div class="item-right"><span class="info"><a class="a-link" href="http://www.laredoute.cn/customer/account/edit/changepass/1/">修改密码</a></span></div>
												</div>
											</div>
											<!--
<a href="http://www.laredoute.cn/customer/account/edit/">编辑</a>
727085496<br />
727085496@qq.com<br />
<a href="http://www.laredoute.cn/customer/account/edit/changepass/1/">修改密码</a>
-->
												...
												<div class="block block-account">
													...
													<div class="block-content">
														<ul>
															...
															<li class="current"><strong>个人信息</strong></li>
															<li>
				...
				<div id="back-top" class="back-top">
					...
					<a href="http://www.laredoute.cn/customer/account/index/#top" class="top"><span class="top-text">TOP</span></a>
				</div>
			</div>
		</div>
		<style>
