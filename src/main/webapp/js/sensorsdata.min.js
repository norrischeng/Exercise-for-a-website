	...
	! function(sd) {
					...
					switch(c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
						...
						case "object":
							...
							if(gap += indent, s = [], "[object Array]" === Object.prototype.toString.apply(c)) {
								for(o = c.length, r = 0; o > r; r += 1) s[r] = str(r, c) || "null";
								return i = 0 === s.length ? "[]" : gap ? "[\n" + gap + s.join(",\n" + gap) + "\n" + a + "]" : "[" + s.join(",") + "]", gap = a, i
							}
							if(rep && "object" == typeof rep)
								for(o = rep.length, r = 0; o > r; r += 1) "string" == typeof rep[r] && (n = rep[r], i = str(n, c), i && s.push(quote(n) + (gap ? ": " : ":") + i));
							else
								for(n in c) Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && s.push(quote(n) + (gap ? ": " : ":") + i));
							return i = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, i
					}
				}
				var rx_one = /^[\],:{}\s]*$/,
		...
		! function() {
			...
			function a(e, t, r, i) {
				...
				}), r.call(i, o.name, o.version)
			}
			var c = "-1",
				u = window,
				d = u.external,
				l = u.navigator.userAgent || "",
				f = u.navigator.appVersion || "",
				p = u.navigator.vendor || "",
		...
		logger.info = function() {
			...
			function() {
				var e = (FuncProto.bind, ArrayProto.forEach),
					...
					i = _.each = function(t, r, i) {
						...
						if(e && t.forEach === e) t.forEach(r, i);
							...
							for(var a in t)
								if(hasOwnProperty.call(t, a) && r.call(i, t[a], a, t) === n) return !1
					};
				...
				var t, r, n, i, o, s, a, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
					d = 0,
					l = 0,
					f = "",
					p = [];
				if(!e) return e;
				e = _.utf8Encode(e);
				do t = e.charCodeAt(d++), r = e.charCodeAt(d++), n = e.charCodeAt(d++), c = t << 16 | r << 8 | n, i = c >> 18 & 63, o = c >> 12 & 63, s = c >> 6 & 63, a = 63 & c, p[l++] = u.charAt(i) + u.charAt(o) + u.charAt(s) + u.charAt(a); while (d < e.length);
				...
				if(document.addEventListener) document.addEventListener("DOMContentLoaded", t, !1);
					...
					document.documentElement.doScroll && !i && r(), document.attachEvent("onreadystatechange", function() {
				...
				function e(e, r, n) {
					var i = function(i) {
						if(i = i || t(window.event)) {
							...
							var o, s, a = !0;
							return _.isFunction(n) && (o = n(i)), s = r.call(e, i), (!1 === o || !1 === s) && (a = !1), a
						}
					};
					return i
				}
				...
				set: function(e, t, r, n, i) {
					...
					if(0 !== r) {
						var d = new Date;
						"s" === String(r).slice(-1) ? d.setTime(d.getTime() + 1e3 * Number(String(r).slice(0, -1))) : d.setTime(d.getTime() + 24 * r * 60 * 60 * 1e3), s = "; expires=" + d.toGMTString()
					}
					i && (a = "; secure"), document.cookie = e + "=" + encodeURIComponent(t) + s + "; path=/" + o + a
				},
				remove: function(e, t) {
				...
				function n(e, r) {
					for(var n = e.charAt(0), i = r.split("&"), o = [], s = {}, a = [], c = e.substring(1), u = 0, d = i.length; d > u; u++)
						if(o = i[u].match(/(.*?)=(.*)/), o || (o = [i[u], i[u], ""]), "" !== o[1].replace(/\s/g, "")) {
				...
				return function(t, i) {
					...
					if(t = t.toString(), o = i.match(/^mailto:([^\/].+)/)) s.protocol = "mailto", s.email = o[1];
					else {
						if((o = i.match(/(.*?)\/#\!(.*)/)) && (i = o[1] + o[2]), (o = i.match(/(.*?)#(.*)/)) && (s.hash = o[2], i = o[1]), s.hash && t.match(/^#/)) return n(t, s.hash);
						if((o = i.match(/(.*?)\?(.*)/)) && (s.query = o[2], i = o[1]), s.query && t.match(/^\?/)) return n(t, s.query);
						if((o = i.match(/(.*?)\:?\/\/(.*)/)) && (s.protocol = o[1].toLowerCase(), i = o[2]), (o = i.match(/(.*?)(\/.*)/)) && (s.path = o[2], i = o[1]), s.path = (s.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")), t.match(/^\//)) return r(t, s.path.substring(1));
						if(o = r("/-1", s.path.substring(1)), o && (o = o.match(/(.*?)\.(.*)/)) && (s.file = o[0], s.filename = o[1], s.fileext = o[2]), (o = i.match(/(.*)\:([0-9]+)$/)) && (s.port = o[2], i = o[1]), (o = i.match(/(.*?)@(.*)/)) && (s.auth = o[1], i = o[2]), s.auth && (o = s.auth.match(/(.*)\:(.*)/), s.user = o ? o[1] : s.auth, s.pass = o ? o[2] : void 0), s.hostname = i.toLowerCase(), "." === t.charAt(0)) return r(t, s.hostname);
						e() && (o = s.hostname.match(e()), o && (s.tld = o[3], s.domain = o[2] ? o[2] + "." + o[3] : void 0, s.sub = o[1] || void 0)), s.port = s.port || ("https" === s.protocol ? "443" : "80"), s.protocol = s.protocol || ("443" === s.port ? "https" : "http")
					}
					return t in s ? s[t] : "{}" === t ? s : void 0
				}
			}(), _.dom = {}, _.getReferrer = function(e) {
				var e = e || document.referrer;
				return 0 === e.indexOf("https://www.baidu.com/") && (e = e.split("?")[0]), e = e.slice(0, sd.para.max_referrer_string_length), "string" == typeof e ? e : ""
			}, _.info = {
				initPage: function() {
					var e = _.getReferrer(),
		...
		var saNewUser = {
				...
				checkIsFirstLatest: function() {
					...
					var r = _.info.campaignParamsStandard("$latest_", "_latest_"),
						n = r.$utms,
						i = r.otherUtms;
					_.isEmptyObject(n) || sd.register(n), _.isEmptyObject(i) || sd.register(i)
				}
			},
			saEvent = {};
		saEvent.checkOption = {
		...
		var store = sd.store = {
				...
				toState: function(e) {
					...
					if(null != e && _.isJSONString(e))
						if(t = JSON.parse(e), t.distinct_id) {
				...
				allTrack: function() {
					...
					var e = {
						getProps: function(e, t) {
							var r = {};
							if(r.$element_type = e, r.$element_name = t.getAttribute("name"), r.$element_id = t.getAttribute("id"), r.$element_class_name = "string" == typeof t.className ? t.className : null, r.$element_target_url = t.getAttribute("href"), t.textContent) {
								var n = _.trim(t.textContent);
								n && (n = n.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), r.$element_content = n
							}
							return r = _.strip_empty_properties(r), r.$url = location.href, r.$url_path = location.pathname, r.$title = document.title, r
						},
						clickEvents: function(e) {
							var t = {},
								r = e.target,
								n = r.tagName.toLowerCase();
							if(-1 !== " button a input ".indexOf(" " + n + " ")) {
								if("input" === n) {
									if("button" !== r.getAttribute("type") && "submit" !== r.getAttribute("type")) return !1;
									t.$element_content = r.value
								}
								_.extend(t, this.getProps(n, r)), "a" === n ? _.trackLink({
									event: e
								}, "$WebClick", t) : sd.track("$WebClick", t)
							}
						}
					};
		...
		sd.quick = function() {
			...
			e = e || {};
			var i = null;
			return e.ele && (i = e.ele), e.event && (i = e.event.target), r = r || {}, i && "object" == typeof i ? !i.href || /^javascript/.test(i.href) || i.target ? (sd.track(t, r), !1) : (e.event && n(e.event), void(e.ele && _.addEvent(e.ele, "click", function(e) {
				n(e)
			}))) : !1
