...
<html>
	...
	<base href="<%=basePath%>">
		...
		<title>编辑地址 | LaRedoute中文官网</title>
...
www.laredoute.cn">
		...
		<link rel="shortcut icon" href="http://o6lmzxerb.bkt.clouddn.com/skin/frontend/PlumTree/lr_pc/favicon.ico" type="img/x-icon">
		...
		<script src="//hm.baidu.com/hm.js?18fc76cc330acbd7b73f47ca2a57fdf1"></script>
		<script type="text/javascript" async="" src="js/htag.js"></script>
		<script async="" src="js/sensorsdata.min.js"></script>
		<script type="text/javascript" async="" src="js/adv"></script>
		<script type="text/javascript" async="" src="js/adv(1)"></script>
		<script type="text/javascript" async="" src="js/presadv"></script>
		<script async="" src="js/a.js"></script>
...
<script type="text/javascript" src="js/ie6.js?v=20171012"></script>
<![endif]-->
...
<div style=' clear: both; text-align:center; position: relative;'>
 <a href="http://windows.microsoft.com/en-US/internet-explorer/products/ie/home?ocid=ie6_countdown_bannercode"><img src="http://storage.ie6countdown.com/assets/100/img/banners/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today." /></a>
</div>
<![endif]-->
	...
	${daoList}
							...
							<div class="col-main">
								<div class="my-account">
									...
									<div class="new-address" style="display: block;">
										<form action="address/updateAddress" method="post" id="PageAddressForm" class="edit-address-page" novalidate="true" style="display: block;">
										<input id="formkey" name="form_key" type="hidden" value="mzwoM91U6K1TaMr6">
											<input type="hidden" name="success_url" value="">
											<input type="hidden" name="error_url" value="">
											<input type="hidden" name="id" value="${param.id }">
											<div class="add-address">
																		<h6 class="title">
                <strong>编辑地址：</strong> (<em>*</em>均为必填)
            </h6>
										<div class="form-line">
												<label for="country"><em>*</em>选择地区：</label>
												<div class="col_2 customer-location">
													<input type="hidden" value="0" id="verify" name="verify">
													<input type="hidden" value="CN" id="country_id"
														name="country_id">
													<p>
														<select id="country" name="nationNoUse" data-value=""
															title="State/country" required=""
															pattern="[^\u56fd\u5bb6\u3001\u5730\u57df]">
															<option value="国家、地域">国家、地域</option>
															<option value="中国大陆">中国大陆</option>
														</select> <select id="region_id" name="region"
															class="validate-select" data-value="" title="州/省"
															required="" pattern="[^\u7701\u4efd]">
															<option value="省份">省份</option>
														</select> <select id="city" name="city" class="required-entry"
															data-value="" title="城市" required=""
															pattern="[^\u5730\u7ea7\u5e02]">
															<option value="地级市">地级市</option>
														</select> <select id="s_county" name="county" data-value=""
															required="" pattern="[^\u5e02\u3001\u53bf\u7ea7\u5e02]">
															<option value="市、县级市">市、县级市</option>
														</select> <span class="adck-tip">收货城市选择不正确</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="col_2">
													<p>
														<input type="text" name="userAddress"
															placeholder="街道门牌号信息" value="" title="街道地址" id="street_1"
															class="input-text required-entry" required=""> <span
															class="adck-tip">地址不能为空</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="col_2">
													<p>
														<input type="text" name="postcode" placeholder="请填写所在地的邮编"
															value="" title="邮政编码" id="postcode"
															class="input-text validate-zip-international required-entry"
															pattern="^\d{6}$" required=""> <span
															class="adck-tip">邮政编码填写不正确</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="col_2 customer-name clearfix">
													<input type="hidden" id="lastname" name="lastname"
														...
														id="verfity-type" value="">
													<p>
														<input id="firstname" name="userName" type="text"
															class="input-text" placeholder="清关需要，请务必填写真实姓名" value=""
															required="" pattern="^[\u4e00-\u9fa5]+$"> <span
															class="adck-tip">姓名不能为空，而且需为中文</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="col_2">
													<p>
														<input type="mobile" name="userPhone"
															placeholder="请输入您的常用联系号码" value="" title="电话"
															class="input-text required-entry" id="telephone"
															required=""> <span class="adck-tip">手机号码填写不正确</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="col_2">
													<p>
														<input value="" placeholder="为方便您及时了解订单状态信息，请填写常用邮箱"
															name="useremail" id="email" type="email"
															class="input-text" required=""> <span
															class="adck-tip">邮箱填写不正确</span>
													</p>
												</div>
											</div>
											<div class="form-line">
												...
												<div class="form-line">
													...
													<!--：</label>-->
													<div class="col_2 input-checkbox">
														<p><strong>预设送货地址</strong></p>
													</div>
												</div>

												<div class="form-line submit-btns">
													<p>
														<input type="submit" id="PageSaveAddress" class="OrangeButton" title="保存地址" value="保存地址">
														<a href="./address/selectAddress?userId=${sessionScope.userInfo.userId }" class="cancel-add-address">取消</a>
													</p>
												</div>
											</div>
											...
											<div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
												<div class="block block-account">
													...
													<div class="block-content">
														<ul>
															<li>
																<a href="./pOrder/shopping?userId=${sessionScope.userInfo.userId }">我的订单</a>
															</li>
															<li>
																<a href="userInfo.jsp">个人信息</a>
															</li>
															<li class="current"><strong>收货地址</strong></li>
															<li>
												...
												<div class="erweima_uni" style="font-size:0;margin-top:18px; padding-bottom: 60px;">
													<img src="img/azoyaclub-LR-center.jpg" alt="" class="mCS_img_loaded">
												</div>
					...
					<script type="text/javascript">
						...
						(function() {
							...
							ha.async = true;
							ha.src = ('https:' == document.location.protocol ? 'https://htag' : 'http://htag') + 'js/htag.js';
				...
				<div id="back-top" class="back-top">
					...
					<a href="http://www.laredoute.cn/customer/address/form/id/8522/#top" class="top"><span class="top-text">TOP</span></a>
				</div>
			</div>
		</div>
		<style>
