...
<html>
	...
	<base href="<%=basePath%>">
		...
		<title>我的收藏夹 | LaRedoute中文官网</title>
...
www.laredoute.cn">
		...
		<script type="text/javascript" async="" src="js/adv.js"></script>
		<script type="text/javascript" async="" src="js/presadv.js"></script>
		<script async="" src="js/a.js"></script>
...
<![endif]-->
	...
	${daoList}
						...
						<div class="main">
							<div class="breadcrumbs">
								<ul class="clearfix">
									...
									<li class="favourites_info">
										<strong class="breadcrumbs-last">我的收藏夹</strong>
									</li>
								</ul>
							</div>
							<div class="col-main">
								<div class="my-account">
									<div class="list-category-name my-favorites">
										<div class="page-title is-products">
											<h1>我的收藏夹 <span>/ My Favorites</span></h1>
										</div>
									</div>
				...
				<div id="back-top" class="back-top">
					...
					<a href="http://www.laredoute.cn/o_customer/favourites/info/#top" class="top"><span class="top-text">TOP</span></a>
				</div>
			</div>
		</div>
		<style>
