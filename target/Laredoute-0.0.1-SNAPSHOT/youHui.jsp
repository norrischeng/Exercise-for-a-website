...
<html>
	...
	<base href="<%=basePath%>">
		...
		<title>我的优惠券 | LaRedoute中文官网</title>
...
<![endif]-->
	...
	${daoList}
						...
						<div class="main">
							...
							<div class="col-main">
								<div class="my-account">
									<div class="account-promocode">
										<div class="title clearfix">
											<span class="left">我的优惠券</span>
											<!--<a class="right" href="">优惠券使用规则Q&amp;A&gt;&gt;</a>-->
										</div>
										<div class="account dib-wrap">
											<label class="dib">请输入优惠码</label>
											<input type="text" id="coupon_code" class="text-input dib">
											<button type="submit" class="dib" id="bindingCoupon">绑定</button>
											<img style="display: none;margin:6px;" id="loading" src="img/ajaxload.gif">
										</div>
										<div class="promo-wrap">

											<div id="202324" class="single clearfix ">
												<div class="left cut-off">
													<span class="price">
                            3欧                        </span>
													<!-- <i>优惠券</i> -->
												</div>
												<div class="left detail">
													<div class="left desc">3欧（新人）</div>
													<div class="left line">|</div>
													<div class="left code">优惠码：3YK8KBSEKGY9</div>
												</div>
												<div class="right other-info">
													<p>2018-03-27前有效</p>
													<p class="expire">距过期还有160天</p>
												</div>
											</div>

											<div id="202325" class="single clearfix ">
												<div class="left cut-off">
													<span class="price">
                            5欧                        </span>
													<!-- <i>优惠券</i> -->
												...
												<div class="left detail">
													<div class="left desc">满50欧减5欧（新人）</div>
													<div class="left line">|</div>
													<div class="left code">优惠码：UC1LDUQ75GL8</div>
												</div>
												<div class="right other-info">
													<p>2018-03-15前有效</p>
													<p class="expire">距过期还有148天</p>
												</div>
											</div>

											<div id="202326" class="single clearfix ">
												<div class="left cut-off">
													<span class="price">
                            7欧                        </span>
													<!-- <i>优惠券</i> -->
												...
												<div class="left detail">
													<div class="left desc">满70欧减7欧（新人）</div>
													<div class="left line">|</div>
													<div class="left code">优惠码：GG4BIMEQZU7Y</div>
												</div>
												<div class="right other-info">
													<p>2018-03-20前有效</p>
													<p class="expire">距过期还有153天</p>
												</div>
											</div>

											<div id="202327" class="single clearfix ">
												<div class="left cut-off">
													<span class="price">
                            10欧                         </span>
													<!-- <i>优惠券</i> -->
												...
												<div class="left detail">
													<div class="left desc">100欧减10欧 （新人）</div>
													<div class="left line">|</div>
													<div class="left code">优惠码：W8IA6KH52DJ7</div>
												</div>
												<div class="right other-info">
													<p>2018-09-21前有效</p>
													<p class="expire">距过期还有338天</p>
												</div>
											</div>
										</div>
				...
				<div id="back-top" class="back-top">
					...
					<a href="http://www.laredoute.cn/customer/account/coupon#top" class="top"><span class="top-text">TOP</span></a>
				</div>
			</div>
		</div>
		<style>
